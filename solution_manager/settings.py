"""
Django settings for solution_manager project.
...
SECRET_KEY = 'django-insecure-fj+@*6qsj!64+6#i%bwsm_*6y%napy2mlm$078_@wyjaw%w%gv'
...
MIDDLEWARE = [
    ...
    'solution_manager.middleware.CleanURLMiddleware'
]
...
WSGI_APPLICATION = 'solution_manager.wsgi.application'
